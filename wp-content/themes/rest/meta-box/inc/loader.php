...
class RWMB_Loader
{
	...
	public function constants()
	{
		...
		define( 'RWMB_JS_URL', get_template_directory_uri() . '/meta-box/js/' );
		define( 'RWMB_CSS_URL', get_template_directory_uri() . '/meta-box/css/'  );

		// Plugin paths, for including files
		define( 'RWMB_DIR', $path );
		define( 'RWMB_INC_DIR', get_template_directory() . '/meta-box/inc/'  );
		define( 'RWMB_FIELDS_DIR', get_template_directory() . '/meta-box/inc/fields/'  );
	}
